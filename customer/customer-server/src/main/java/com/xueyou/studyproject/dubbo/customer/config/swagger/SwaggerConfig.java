package com.xueyou.studyproject.dubbo.customer.config.swagger;
...
public class SwaggerConfig {
    ...
    public Docket customDocket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.xueyou.studyproject.dubbo.customer.controller"))
                .build();
    }
